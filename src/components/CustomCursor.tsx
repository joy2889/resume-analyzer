...
export const CustomCursor: React.FC = () => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[100] print:hidden overflow-hidden mix-blend-difference">
      {/* Ambient Glow */}
      <motion.div
        className="absolute w-[400px] h-[400px] rounded-full bg-white/10 blur-[80px]"
        animate={{
