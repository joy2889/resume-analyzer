...
export const ResumePreview: React.FC<ResumePreviewProps> = ({
  ...
  return (
    <div className="flex flex-col relative w-full h-full">
      {/* Top action bar - Maximalist Style */}
      <div className="flex flex-col sm:flex-row justify-between items-center bg-[#2D1B4E] border-4 border-[#00F5D4] rounded-2xl p-4 mb-6 shadow-multi print:hidden">
        <div className="flex items-center gap-3 mb-4 sm:mb-0">
          <div className="bg-[#FF3AF2] p-2 rounded-lg border-2 border-[#FFE600] shadow-[2px_2px_0_#0D0D1A]">
            <Edit3 size={24} className="text-white" />
          </div>
          <div>
            <h3 className="font-heading font-black text-2xl uppercase text-[#FFE600] tracking-wider leading-none">
              Live Preview
            </h3>
            <p className="text-[#00F5D4] font-bold text-sm">Click any text block below to edit instantly.</p>
          </div>
        </div>
        
        <button 
          onClick={printDocument}
          className="bg-gradient-to-r from-[#FF6B35] to-[#FFE600] border-4 border-[#FF3AF2] text-[#0D0D1A] px-6 py-3 rounded-full font-black uppercase tracking-widest shadow-[4px_4px_0_#00F5D4] hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
        >
      ...
      {/* Actual Resume Page */}
      <div className="bg-white text-black p-8 md:p-12 shadow-2xl mx-auto w-full max-w-4xl" style={{ minHeight: "1056px", fontFamily: isModern ? 'Arial, sans-serif' : '"Times New Roman", Times, serif' }}>
        
        {/* HEADER SECTION */}
        <div className={`mb-6 border-b-2 border-black pb-4 ${isModern ? 'text-left' : 'text-center'}`}>
          <input
            type="text"
            value={personalInfo.name}
            onChange={(e) => handleInfoChange("name", e.target.value)}
            className={`w-full bg-transparent font-bold text-3xl focus:outline-none focus:bg-gray-100 p-1 ${isModern ? 'text-left' : 'text-center'}`}
          />
          <input
            type="text"
        ...
        {/* SUMMARY SECTION */}
        <div className="mb-6">
          <h3 className="font-bold text-lg uppercase tracking-wider mb-2 border-b border-gray-400">Professional Summary</h3>
          <textarea
            value={data.summary}
        ...
        <div className="mb-6">
          <h3 className="font-bold text-lg uppercase tracking-wider mb-2 border-b border-gray-400">Core Competencies</h3>
        ...
        <div className="mb-6">
          <h3 className="font-bold text-lg uppercase tracking-wider mb-4 border-b border-gray-400">Professional Experience</h3>
        ...
        {/* EDUCATION SECTION */}
        <div>
          <h3 className="font-bold text-lg uppercase tracking-wider mb-2 border-b border-gray-400">Education</h3>
          <div className="flex justify-between font-bold text-sm mb-1">
            <input 
              type="text" 
